...
public class LorannModel implements ILorannModel {
    ...
    public LorannModel(final String fileName, final int myVehicleStartX, final int myVehicleStartY, 
    		final int Monster1startX, final int Monster1startY, 
    		final int Monster2startX, final int Monster2startY, 
    		final int Monster3startX, final int Monster3startY, 
    		final int Monster4startX, final int Monster4startY)
            throws IOException {
