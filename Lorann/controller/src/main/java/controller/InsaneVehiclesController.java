...
import view.IInsaneVehiclesView;
	...
	public final void play() throws InterruptedException {
		while (this.getModel().getMyVehicle().isAlive()) {
			...
			case UP:
				...
				break;
			case UPLEFT:
				this.getModel().getMyVehicle().moveUpLeft();
				break;
			case UPRIGHT:
				this.getModel().getMyVehicle().moveUpRight();
				break;
			case DOWNLEFT:
				this.getModel().getMyVehicle().moveDownLeft();
				break;
			case DOWNRIGHT:
				this.getModel().getMyVehicle().moveDownRight();
				break;
			case NOP:
				this.getModel().getMyVehicle().doNothing();
				break;
			case SPACE:
				this.getModel().getMyVehicle().fire();
				break;
			}
