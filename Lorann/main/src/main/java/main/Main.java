...
public abstract class Main {
	...
	public static void main(final String[] args) throws IOException, InterruptedException {
		...
		final LorannView view = new LorannView(model.getRoad(), model.getMyLorann(), model.getMonster1(),
				model.getMonster2(), model.getMonster3(), model.getMonster4(), model.getSpell());
