...
public class InsaneVehiclesView implements Runnable, KeyListener, IInsaneVehiclesView {
	 ...
	 */
	public InsaneVehiclesView(final IRoad road, final IMobile myVehicle, final IMobile monster1, final IMobile monster2,
	...
	public final void show(final int yStart) {
		...
		for (int view = 0; view < this.getView(); view++) {
			for (int x = 0; x < this.getRoad().getWidth(); x++) {
				...
				} else if ((x == this.getMonster1().getX()) && (y == yStart)) {
					System.out.print(this.getMonster1().getSprite().getConsoleImage());
				} else if ((x == this.getMonster2().getX()) && (y == yStart)) {
					System.out.print(this.getMonster2().getSprite().getConsoleImage());
				} else if ((x == this.getMonster3().getX()) && (y == yStart)) {
					System.out.print(this.getMonster3().getSprite().getConsoleImage());
				} else if ((x == this.getMonster4().getX()) && (y == yStart)) {
					System.out.print(this.getMonster4().getSprite().getConsoleImage());
				} else {
